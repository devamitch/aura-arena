...
import { ArrowLeft, Bell, Trophy, Swords, Heart, Star, Check, CheckCheck } from 'lucide-react';
import { useStore, useNotifications, useUnreadCount } from '@store';
      ...
      <div className="flex items-center justify-between px-5 pt-6 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {unread > 0 && <p className="text-[11px] text-t3">{unread} unread</p>}
          </div>
        </div>
        {unread > 0 && (
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-t1 leading-tight">{n.title}</p>
                  <p className="text-xs text-t3 mt-0.5 leading-snug">{n.body}</p>
                  <p className="text-[10px] text-t3 mt-1 font-mono">{timeAgo(n.createdAt)}</p>
                </div>
