...
const REELS = [
  {
    id: "r1",
    username: "@shadowpunch",
    arenaName: "ShadowPunch",
    discipline: "Boxing",
    disciplineEmoji: "🥊",
    subDiscipline: "Orthodox",
    score: 94.2,
    drillName: "Hook & Uppercut Series",
    caption:
      "New personal best 🔥 the timing finally clicked after 3 weeks. tag a boxer who needs to see this",
    likes: 2314,
    comments: 187,
    tier: "Champion",
    tierColor: "#a78bfa",
    accentColor: "#00f0ff",
    bg: `radial-gradient(ellipse at 30% 30%, rgba(0,240,255,0.3) 0%, transparent 55%),
        radial-gradient(ellipse at 80% 70%, rgba(0,240,255,0.15) 0%, transparent 50%),
  ...
  },
  {
    id: "r2",
    username: "@neondancer",
    arenaName: "NeonDancer",
    discipline: "Dance",
    disciplineEmoji: "💃",
    subDiscipline: "Bharatanatyam",
    score: 88.7,
    drillName: "Mudra Flow — Alarippu",
    caption:
      "Classical meets contemporary. the floor lights up when this sequence hits 🪷",
    likes: 1873,
    comments: 241,
    tier: "Platinum",
    tierColor: "#38bdf8",
  ...
  },
  {
    ...
    disciplineEmoji: "🥋",
    subDiscipline: "Shotokan",
    score: 91.8,
    drillName: "Kata Heian Shodan — Full",
    caption:
      "Kata is not about fighting. it is about perfecting movement. every angle matters.",
    likes: 3102,
    comments: 328,
    tier: "Elite",
    tierColor: "#f43f5e",
  ...
  },
  {
    ...
    score: 96.1,
    drillName: "Warrior III → Bound Angle",
    caption:
      "Balance is a conversation with gravity, not a fight 🌿 breath is everything",
    likes: 891,
    comments: 73,
    tier: "Gold",
    tierColor: "#fbbf24",
...
const ScoreRing = memo(({ score, color }: { score: number; color: string }) => {
  ...
  return (
    <div className="relative w-14 h-14 flex items-center justify-center">
      ...
      <p className="relative z-10 text-[13px] font-black tabular-nums text-white">
        {Math.round(score)}
      </p>
    </div>
  );
      ...
      >
        ...
        >
          <Icon
            ...
            style={{
              color:
                active && activeColor ? activeColor : "rgba(255,255,255,0.88)",
            }}
        ...
        {count !== undefined && (
          <span className="text-[10px] font-mono text-white/60 tabular-nums leading-none">
            {fmtN(count)}
          </span>
        )}
      </button>
...
const ReelView = memo(({ reel, active }: { reel: Reel; active: boolean }) => {
  ...
  const shortCaption =
    reel.caption.length > 90 ? reel.caption.slice(0, 88) + "…" : reel.caption;
  ...
  return (
    <div className="absolute inset-0 overflow-hidden" onClick={handleTap}>
      ...
      {/* Disc watermark */}
      <div
        className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[160px] select-none pointer-events-none"
        style={{ opacity: 0.04 }}
      >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(0deg, rgba(4,6,16,0.95) 0%, rgba(4,6,16,0.45) 45%, transparent 65%)",
        }}
      />
      ...
      <div className="absolute top-[5.5rem] right-4 flex flex-col items-center gap-1.5">
        ...
        <div
          ...
          style={{
            background: `${reel.accentColor}22`,
      ...
      <AnimatePresence>
        {doubleTapHeart && (
          <motion.div
            ...
            style={{
              position: "absolute",
              left: doubleTapHeart.x - 44,
              top: doubleTapHeart.y - 44,
              fontSize: 88,
              pointerEvents: "none",
            }}
          >
        ...
        <div className="flex items-center gap-2.5 mb-2.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p
              ...
              style={{ color: `${reel.accentColor}cc` }}
            >
              {reel.username} · {reel.subDiscipline}
            </p>
          </div>
          <div
            className="px-2 py-0.5 rounded-full flex-shrink-0 text-[9px] font-mono"
            style={{
              background: `${reel.tierColor}18`,
              color: reel.tierColor,
              border: `1px solid ${reel.tierColor}30`,
            }}
          >
            {reel.tier}
          </div>
...
export default function ReelsFeedPage() {
  ...
  const onTouchEnd = (e: RTE) => {
    ...
    if (isSwipe) goTo(index + (dy < 0 ? 1 : -1), vel);
      ...
      animate(y, -index * H, { type: "spring", stiffness: 400, damping: 38 });
  };
    ...
    >
      ...
      <div className="absolute top-0 left-0 right-0 z-20 pointer-events-none">
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(4,6,16,0.8) 0%, transparent 100%)",
          }}
        />
      </div>
      <div className="absolute top-0 left-0 right-0 z-30">
        <div className="flex items-center justify-between px-4 pt-14 pb-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <span
              className="text-[10px] font-mono text-white/40 px-1.5 py-0.5 rounded-md"
      ...
      <div className="absolute right-1 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-1.5 pointer-events-none">
        {REELS.map((r, i) => (
          <motion.div
            ...
            style={{
              background:
                i === index ? REELS[i].accentColor : "rgba(255,255,255,0.5)",
            }}
          />
        ))}
      </div>
