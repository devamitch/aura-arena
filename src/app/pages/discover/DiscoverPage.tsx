  ...
  return (
    <div className="page pb-safe bg-void">
      ...
      <div className="px-5 grid grid-cols-2 gap-3 mb-6">
        {[
          ...
          },
          {
            ...
            grad: "from-purple-600 to-magenta-500",
            desc: "Rankings",
          },
        ].map((card) => {
          ...
          return (
            ...
            >
              ...
              <p className="font-black text-white text-sm relative z-10">
                {card.label}
              </p>
              <p className="text-white/60 text-[10px] relative z-10">
                {card.desc}
              </p>
            </motion.button>
          );
        ...
        <div className="space-y-2">
          {TRENDING.map((reel, i) => (
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => navigate("/discover/reels")}
              className="w-full flex items-center gap-3 p-3 bg-card/60 backdrop-blur-xl border-white/5 shadow-sm rounded-xl text-left hover:border-accent/30 transition-colors"
            >
      ...
      <div className="px-5 mt-6">
        <Card className="p-4 bg-card/60 backdrop-blur-xl border-white/10 shadow-lg">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            {[
              ...
              <div key={s.label}>
                <p
                  className="font-black text-t1 text-lg"
                  style={{ color: accentColor }}
                >
                  {s.value}
                </p>
