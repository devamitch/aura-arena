      ...
      <AnimatePresence mode="wait">
        {phase === "select" && (
          ...
          >
            <p className="text-sm text-t3">
              Connect your fitness tracker to import your training history and
            ...
            >
              ...
              {source
                ? `Import from ${SOURCES.find((s) => s.id === source)?.label}`
                : "Select a Source"}
            </button>
          </motion.div>
        )}
        ...
        {phase === "importing" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="px-5 flex flex-col items-center justify-center py-20 gap-6"
          >
            <motion.div
              animate={{ rotate: 360 }}
          ...
          >
            <div className="text-center py-8">
              ...
              <p className="text-t3 text-sm">
                {count} sessions imported successfully
              </p>
            </div>

            {insight && (
              <div className="bg-s1 rounded-2xl p-4 border border-b1">
                <p className="text-xs font-mono text-t3 uppercase tracking-widest mb-2">
                  AI Insight
                </p>
